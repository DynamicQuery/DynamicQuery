...
namespace DynamicFilter.Common.Interfaces
{
    ...
    {
        /// <summary>
        /// Every filter has a connector that can be None, And or Or
        /// </summary>
        ...
        /// </summary>
        IDynamicFilter Group { get; }

        /// <summary>
        /// List of statements groups that compose this filter.
        /// </summary>
        IEnumerable<IEnumerable<IDynamicFilterStatement>> StatementGroups { get; }
        ...
        IDynamicFilterStatementConnection By(string propertyId, IOperation operation);
        ...
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IDynamicFilterStatementConnection By(string propertyId, IOperation operation, Connector connector);
        ...
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IDynamicFilterStatementConnection By<TPropertyType>(string propertyId, IOperation operation, TPropertyType value);
        ...
        /// <param name="connector">Establishes how this filter statement will connect to the next one.</param>
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IDynamicFilterStatementConnection By<TPropertyType>(string propertyId, IOperation operation, TPropertyType value, Connector connector);
        ...
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IDynamicFilterStatementConnection By<TPropertyType>(string propertyId, IOperation operation, TPropertyType value, TPropertyType value2);
        ...
        /// <param name="connector">Establishes how this filter statement will connect to the next one.</param>
        /// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
        IDynamicFilterStatementConnection By<TPropertyType>(string propertyId, IOperation operation, TPropertyType value, TPropertyType value2, Connector connector);
